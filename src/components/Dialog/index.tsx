    ...
    <Transition show={open}>
      <Dialog className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-1 pb-0 text-center sm:items-center sm:p-0">
            <TransitionChild
              enter="ease-out duration-300"
            ...
            >
              <DialogPanel className="relative transform overflow-hidden rounded-lg dark:bg-[#0f172a]  bg-white text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg">
